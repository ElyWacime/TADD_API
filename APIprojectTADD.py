...
surfaces_configurations = [
    ...
    {"name": "toiture_surface1", "surface": toiture_surface1, "bifac": bifac_toitureS1, "bifac_ratio": bifac_ratio_toitureS1, "H": H_toitureS1, "inter": inter_toitureS1},
    {"name": "toiture_surface2", "surface": toiture_surface2, "bifac": bifac_toitureS2, "bifac_ratio": bifac_ratio_toitureS2, "H": H_toitureS2, "inter": inter_toitureS2},
    {"name": "toiture_surface3", "surface": toiture_surface3, "bifac": bifac_toitureS3, "bifac_ratio": bifac_ratio_toitureS3, "H": H_toitureS3, "inter": inter_toitureS3},
    {"name": "toiture_surface4", "surface": toiture_surface4, "bifac": bifac_toitureS4, "bifac_ratio": bifac_ratio_toitureS4, "H": H_toitureS4, "inter": inter_toitureS4},
    {"name": "toiture_surface5", "surface": toiture_surface5, "bifac": bifac_toitureS5, "bifac_ratio": bifac_ratio_toitureS5, "H": H_toitureS5, "inter": inter_toitureS5},
    {"name": "toiture_surface6", "surface": toiture_surface6, "bifac": bifac_toitureS6, "bifac_ratio": bifac_ratio_toitureS6, "H": H_toitureS6, "inter": inter_toitureS6},
    # Configurations for ombrière
    {"name": "ombriere_surface1", "surface": ombriere_surface1, "surface_azimuth": surface_azimuth_ombS1, "surface_tilt": surface_tilt_ombS1, "bifac": bifac_ombS1, "bifac_ratio": bifac_ratio_ombS1, "H": H_ombS1, "inter": inter_ombS1},
    {"name": "ombriere_surface2", "surface": ombriere_surface2, "surface_azimuth": surface_azimuth_ombS2, "surface_tilt": surface_tilt_ombS2, "bifac": bifac_ombS2, "bifac_ratio": bifac_ratio_ombS2, "H": H_ombS2, "inter": inter_ombS2},
    {"name": "ombriere_surface3", "surface": ombriere_surface3, "surface_azimuth": surface_azimuth_ombS3, "surface_tilt": surface_tilt_ombS3,"bifac": bifac_ombS3, "bifac_ratio": bifac_ratio_ombS3, "H": H_ombS3, "inter": inter_ombS3},
    # Configurations for serre
    {"name": "serre_surface1", "surface": serre_surface1, "surface_azimuth": surface_azimuth_serS1, "surface_tilt": surface_tilt_serS1,"bifac": bifac_serS1, "bifac_ratio": bifac_ratio_serS1, "H": H_serS1, "inter": inter_serS1},
    {"name": "serre_surface2", "surface": serre_surface2, "surface_azimuth": surface_azimuth_serS2, "surface_tilt": surface_tilt_serS2, "bifac": bifac_serS2, "bifac_ratio": bifac_ratio_serS2, "H": H_serS2, "inter": inter_serS2},
    {"name": "serre_surface3", "surface": serre_surface3, "surface_azimuth": surface_azimuth_serS3, "surface_tilt": surface_tilt_serS3, "bifac": bifac_serS3, "bifac_ratio": bifac_ratio_serS3, "H": H_serS3, "inter": inter_serS3},
]
...
Itot_for_config = {config["name"]: calculate_Itot_for_each_configuration(config) for config in surfaces_configurations}
#######*********########
...
def calculate_AOI_for_config(config):
    if "surface_azimuth" in config:
        result = pvlib.irradiance.aoi(config["surface_tilt"], config["surface_azimuth"], solar_zenith, solar_azimuth)
        return result

AOI_for_config = {config["name"]: calculate_AOI_for_config(config) for config in surfaces_configurations}
...
IAM_for_config = {config["name"]: calculate_IAM_for_config(config) for config in surfaces_configurations}
TMY_global_for_config = {config["name"]: TMY_global for config in surfaces_configurations}
...
for config in surfaces_configurations:
    ...
    if config_name in TMY_global_for_config and config_name in IAM_for_config:
        if IAM_for_config[config_name] is not None:
            ...
            effective_irr_for_config = TMY_global_for_config[config_name]['Itot0']*(1-soiling)
print(effective_irr_for_config)
#########***************###########
